...
// methods in this file were ported from zpay32. We should use there's as soon as possible.
// original file: https://github.com/lightningnetwork/lnd/blob/master/zpay32/bech32.go
